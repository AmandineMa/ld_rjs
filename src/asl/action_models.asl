...
actionModel(pick(Human,Pickable),[isInContainer(Pickable,Container)],[rightHandMovingTowards(Human,PickableList)],[],[hasInLeftHand(Human,Pickable)]).
...
actionModel(place(Human,Pickable,Support),[hasInLeftHand(Human,Pickable)],[rightHandMovingTowards(Human,SupportList)],[~hasInLeftHand(Human,Pickable)],[isOnTopOf(Pickable,Support)]).

actionModel(placeStick(Human,Pickable,Support1,Support2),[hasInLeftHand(Human,Pickable)],[rightHandMovingTowards(Human,SupportList)],[~hasInLeftHand(Human,Pickable)],[isOnTopOf(Pickable,Support1),isOnTopOf(Pickable,Support2)]).
