...
public class insert_abstract_task_mementar extends DefaultInternalAction {
	
	protected Logger logger = Logger.getLogger(insert_abstract_task_mementar.class.getName());
