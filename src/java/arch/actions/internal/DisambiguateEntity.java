...
public class DisambiguateEntity extends AbstractAction {

	public DisambiguateEntity(ActionExec actionExec, AbstractROSAgArch rosAgArch) {
	...
	public void execute() {
		...
		List<String> ontoRep = ((LAASAgArch) rosAgArch).callOntoIndivRobot("getOn", individual+":isAbove").getValues();
		if(!ontoRep.isEmpty()) {
